...
**Candidate setup.** Configuration syntax verified against current official documentation. Codex CLI
`0.154.0` was qualified for `v0.4.2` against `RELEASE_CANDIDATE_SHA = 50862a352626ea38d2fbb36f2ff0ecfc667266d0` —
