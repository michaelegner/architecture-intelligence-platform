...
# confirmed_relations()/observed_only_relations() filter evidence by last_seen against that window,
# so an out-of-window timestamp would silently produce no observed evidence at all.
