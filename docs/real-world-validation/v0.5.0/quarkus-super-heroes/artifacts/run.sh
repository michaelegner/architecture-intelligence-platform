#!/usr/bin/env bash
# Generated from the frozen runbook docs/real-world-validation/v0.5.0/quarkus-super-heroes/runbook.md (blocks 1-10, verbatim) at candidate 174a17c.
...
export RUN_DIR=/tmp/claude-1001/-home-michael-code-ArchitectureIntelligencePlatform/dea4adeb-9305-40aa-944d-829d6415b869/scratchpad/i5-s5/quarkus
...
export NEO4J_PASSWORD="$(cat /tmp/claude-1001/-home-michael-code-ArchitectureIntelligencePlatform/dea4adeb-9305-40aa-944d-829d6415b869/scratchpad/i5-s5/quarkus/.neo4j-password)"
