...
| [`v0.4.2-rc.1-candidate-preparation.md`](v0.4.2-rc.1-candidate-preparation.md) | I3.2's candidate freeze and full automated gate-table qualification (version identity, live `producer.build_revision`, clean-checkout regression/evaluation/repeatability, CI identity, hygiene, link validation) for `v0.4.2-rc.1`, `71e2d8b954fa92430723fced302baa3666255397` — no fix commit needed, since version identity was already structurally consistent by construction. Actual-client qualification, the GO/NO-GO decision, and publication remain later I3 sub-slices. |
