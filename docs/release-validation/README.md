...
| [`v0.3.0-go-no-go.md`](v0.3.0-go-no-go.md) | I5.2's full release-readiness record for `v0.3.0-rc.2` — source, real-system, Quick Start, GHCR artifact, CI/CodeQL/Trivy qualification, release blockers, and the GO recommendation (decision pending the repository owner). |
