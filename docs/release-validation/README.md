...
| [`v0.4.0-go-no-go.md`](v0.4.0-go-no-go.md) | I4.2's full technical-precondition qualification for `v0.4.0-rc.1` — source, hero demo, local and published-image smoke, CI/CodeQL/Trivy, release blockers. States every precondition `VERIFIED` but does not itself decide GO/NO-GO — that is I4.3's job. |
