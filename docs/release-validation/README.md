...
| [`v0.3.0-release-notes.md`](v0.3.0-release-notes.md) | Draft final `v0.3.0` GitHub Release notes, prepared during I5.1 for I5.3's use after the I5.2 GO decision — not itself a published release. |
...
| [`v0.3.0-go-no-go.md`](v0.3.0-go-no-go.md) | I5.2's full release-readiness record for `v0.3.0-rc.2` — source, real-system, Quick Start, GHCR artifact, CI/CodeQL/Trivy qualification, release blockers, and the recorded owner decision: **GO**. I5.2 is closed; I5.3 (publish `v0.3.0`) is next. |
