...
**Status: release candidate — not a published release.** v0.5.0 is not shipped until the
publication and post-release verification records exist. Links in this file are relative to the
repository; the published release body pins them to the release tag.
...
- **Source ingestion foundation.** One adapter/discoverer seam serves OpenAPI, AsyncAPI, the
  ...
  - **Import report.** `POST /api/import` now also returns a versioned import report
    ...
    diagnostics. See [`docs/ingestion.md`](../ingestion.md).
...
- **The direct MCP envelope is retired.** `POST /mcp` now serves standard negotiated MCP only. The
  ...
  gone. See [ADR 0016](../adr/0016-public-architecture-knowledge-adapters.md) and
  [`docs/mcp.md`](../mcp.md). This is an intentional pre-1.0 breaking change.
...
- **`schema_version` is `"0.5"`.** The answer schemas are under
  [`schemas/architecture_intelligence/v0.5/`](../../schemas/architecture_intelligence/v0.5/) and
  the import-report schemas under [`schemas/import/v0.5/`](../../schemas/import/v0.5/).
...
- **The MCP client matrix is from v0.4.2.** Codex CLI, Claude Code, Cursor and VS Code + GitHub
  ...
  v0.5.0. See the
  [v0.4.2 client matrix](v0.4.2-client-qualification.md).
...
- [v0.5.0 specification](../specifications/0.5.0/specification.md) and its increment completion
  records: [I1](../specifications/0.5.0/i1-completion-record.md),
  [I2](../specifications/0.5.0/i2-completion-record.md),
  [I3](../specifications/0.5.0/i3-completion-record.md),
  [I4](../specifications/0.5.0/i4-completion-record.md) and
  [I5](../specifications/0.5.0/i5-completion-record.md)
- Real-system qualification: [`docs/real-world-validation/v0.5.0/`](../real-world-validation/v0.5.0/)
- Release golden path: [`examples/release-golden-path/`](../../examples/release-golden-path/README.md)
